...
void runDistance(GpuResources* resources,
                 Tensor<T, 2, true>& centroids,
                 bool centroidsRowMajor,
                 Tensor<U, 1, true>* centroidNorms,
                 Tensor<T, 2, true>& queries,
                 bool queriesRowMajor,
                 int k,
                 Tensor<U, 2, true>& outDistances,
    ...
    if (!centroidNorms) {
        cNorms =
                std::move(DeviceTensor<U, 1, true>(
    ...
    DeviceTensor<U, 1, true> queryNorms(mem, qNormSize, defaultStream);
    ...
    DeviceTensor<U, 2, true> distanceBuf1(
            mem, {tileRows, tileCols}, defaultStream);
    DeviceTensor<U, 2, true> distanceBuf2(
            mem, {tileRows, tileCols}, defaultStream);
    DeviceTensor<U, 2, true>* distanceBufs[2] =
            {&distanceBuf1, &distanceBuf2};

    DeviceTensor<U, 2, true> outDistanceBuf1(
            mem, {tileRows, numColTiles * k}, defaultStream);
    DeviceTensor<U, 2, true> outDistanceBuf2(
            mem, {tileRows, numColTiles * k}, defaultStream);
    DeviceTensor<U, 2, true>* outDistanceBufs[2] =
...
runIPDistance(GpuResources* resources,
              ...
              Tensor<int, 2, true>& outIndices) {
  runIPDistance<float, float>(resources,
                             vectors,
                             vectorsRowMajor,
                             queries,
                             queriesRowMajor,
...
runIPDistance(GpuResources* resources,
              ...
              Tensor<float, 2, true>& outDistances,
              Tensor<int, 2, true>& outIndices) {
  runIPDistance<half, float>(resources,
                            vectors,
                            vectorsRowMajor,
                            queries,
                            queriesRowMajor,
...
runIPDistance(GpuResources* resources,
              ...
              Tensor<int, 2, true>& outIndices) {
    runIPDistance<int8_t, int>(resources,
                               vectors,
                               vectorsRowMajor,
                               queries,
                               queriesRowMajor,
...
runL2Distance(GpuResources* resources,
              ...
              Tensor<int, 2, true>& outIndices,
              bool ignoreOutDistances) {
  runL2Distance<float, float>(resources,
                             vectors,
                             vectorsRowMajor,
                             vectorNorms,
                             queries,
...
runL2Distance(GpuResources* resources,
              ...
              Tensor<int, 2, true>& outIndices,
              bool ignoreOutDistances) {
  runL2Distance<half, float>(resources,
                             vectors,
                             vectorsRowMajor,
                             vectorNorms,
                             queries,
